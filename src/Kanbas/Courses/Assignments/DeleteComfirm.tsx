...
const DeleteComfirm = ({dialogTitle, deleteAssignment} : {
    dialogTitle: string;
  ...
  return (
    <div id="wd-delete-dialog" className="modal fade" data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        <div className="modal-content">
            <div className="modal-header">Delete Assignment</div>
            <div className='m-3'>Are you sure you want to delete this assignment?</div>
